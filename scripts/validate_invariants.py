...
'transfer_boundaries':{'from_ticket_id','to_ticket_id','scheduled_buffer_minutes','required_buffer_minutes','evidence_id','evaluation_status','evaluation_reason','evaluated_at','evaluation_expires_at','arrival_airport','departure_airport','overnight_transfer','airport_change_policy_id'},
...
'audit_evidence':{'gate_id','spec_version','commit_sha','test_report_hash','provider_readback','unresolved_items'},
'source_onboarding_reviews':{'review_id','source_id','target_state','access_basis','terms_snapshot_at','evidence_id','payload_sha256','reviewer_key_id','created_at'},
'provider_access_reviews':{'review_id','provider_id','access_basis','terms_snapshot_at','rate_policy','evidence_id','payload_sha256','reviewer_key_id','created_at'},
...
'candidate_verification_supports':{'result_id','provider_offer_id','support_role','created_at'},
'live_offer_lifecycle_events':{'event_id','result_id','queue_id','query_fingerprint','itinerary_id','provider_offer_id','previous_verification_state','new_verification_state','reason','effective_at','support_provider_ids_json','had_visible_notification','correction_state','reprice_state','last_error','created_at','updated_at'},
...
'ingest_auth_keys':{'key_id','role','source_id','agency_id','provider_id','secret_slot','allowed_paths_json','enabled','not_before','expires_at'},
