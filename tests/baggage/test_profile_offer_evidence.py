...
def test_included_checked_bag_quantity_does_not_prove_requested_weight():
    ...
    assert x['status']=='UNKNOWN' and x['reason']=='INCLUDED_BAG_WEIGHT_UNKNOWN'
def test_included_checked_bag_with_weight_evidence_can_pass():
    structure={"slices":[{"segments":[{"passengers":[{"passenger_id":"p1","baggages":[{"type":"checked","quantity":1,"weight_kg":23}]}]}]}],"available_services":[]}
