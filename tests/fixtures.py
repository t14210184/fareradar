...
def plan():
    ...
    return {
      ...
      "costs":[{"cost_id":"c1","type":"OFFER_TOTAL","amount":5000,"currency":"TWD","twd_amount":5000,"inclusion_state":"INCLUDED_IN_OFFER","dedupe_key":"offer-total","certainty":"CONFIRMED","paid_state":"UNPAID","refundable":False,"observed_at":obs},{"cost_id":"c2","type":"BAGGAGE","amount":900,"currency":"TWD","twd_amount":900,"inclusion_state":"ADD_ON","dedupe_key":"bag-20kg","certainty":"CONFIRMED","paid_state":"UNPAID","refundable":False,"observed_at":obs}],
      "readiness":facets,
