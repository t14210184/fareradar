...
await upsertRuntimeProfile(db,{profile_id:'synthetic-private-profile',home_city:'Synthetic',home_airports:['TPE','TSA'],checked_bag_pattern:'RETURN_ONLY',baggage_kg:20,seat_required:false,red_eye_ok:true,self_transfer_ok:true,overnight_transfer_ok:false,airport_change_ok:false,mainland_permit_status:'UNKNOWN',korea_entry_profile:'CHECK_AT_QUERY_TIME',foreign_origin_ok:true,positioning_cost_attribution:'FULL',max_positioning_cost_twd:2500,value_of_time_twd_per_hour:300,min_savings_for_self_transfer_twd:2500,currency:'TWD'},'2026-09-15T00:00:00Z');
