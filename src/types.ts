...
export interface TransferBoundaryInput { boundary_id:string; from_ticket_id:string; to_ticket_id:string; airport:string; arrival_airport?:string|null; departure_airport?:string|null; self_transfer:boolean; protection_type:string; validating_carrier?:string|null; mct_status?:string|null; requires_entry:boolean; requires_bag_reclaim:boolean; through_bag_status?:string|null; terminal_change:boolean; airport_change:boolean; overnight_transfer?:boolean; scheduled_buffer_minutes:number; required_buffer_minutes:number; buffer_confidence:string; reaccommodation_basis?:string|null; evidence_id:string; }
export interface CostComponentInput { cost_id:string; type:string; amount:number; currency:string; twd_amount:number|null; inclusion_state:"INCLUDED_IN_OFFER"|"ADD_ON"|"UNKNOWN"; source_offer_id?:string|null; policy_evidence_id?:string|null; source_evidence_id?:string|null; dedupe_key:string; certainty:string; effective_event_at?:string|null; paid_state:string; refundable:boolean; fx_snapshot_id?:string|null; observed_at:string; evidence_expires_at?:string|null; }
